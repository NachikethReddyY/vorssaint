...
- **Privacy screen.** Open a dedicated Privacy Share window and choose that window in Zoom, Meet or another calling app. It mirrors the desktop normally; a customizable shortcut heavily blurs, enlarges and darkens only the shared view beneath your message while the real desktop stays visible and usable. This translucent mode intentionally preserves coarse colors and motion, so use it to obscure readable details rather than as irreversible redaction.
